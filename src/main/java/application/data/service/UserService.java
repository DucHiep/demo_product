...
public class UserService {
    ...
    public PaginableItemList<User> getListUser(int pageSize, int pageNumber) {

        PaginableItemList<User> paginableItemList = new PaginableItemList<>();
        paginableItemList.setPageSize(pageSize);
        paginableItemList.setPageNumber(pageNumber);

        Page<User> pages = userRepository.findAll(new PageRequest(pageNumber, pageSize));
